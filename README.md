...
Using a _10kohm_ resistor and a _47nF_ capacitor to filter the pwm signal, an output as seen below, can be achieved. Its not pretty but might be usefull for some gritty music purposes. Analog filtering and amplification might be able to save some of the lost amplitude.
